...
function PurchaseAddressBox() {
  ...
  return (
    <>
      <div className="w-full bg-amber-100 p-3 rounded-2xl flex flex-col gap-2 sm:gap-4 relative">
      ...
      <Link
        to="/address"
        className="text-[0.5rem] sm:text-[0.65rem] text-blue-400 underline ml-2"
      >
        Edit address
      </Link>
    </>
