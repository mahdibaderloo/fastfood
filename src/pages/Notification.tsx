...
function Notification() {
  ...
  return (
    <div>
      ...
      <main className="p-4 pt-16 h-screen flex flex-col gap-2 sm:w-90 sm:mx-auto">
        <h2 className="text-lg sm:text-xl text-neutral-950 dark:text-amber-300">
          Notification Title #{params.notificationId}
        </h2>
        <p className="text-neutral-900/80 dark:text-amber-300/50 text-[0.7rem] sm:text-[0.8rem]">
          Today at 10:00 AM
        </p>
        <p className="text-neutral-800 dark:text-amber-50/90 text-[0.6rem] sm:text-[0.7rem] mt-2 w-full text-justify">
