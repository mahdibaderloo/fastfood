...
function Support() {
  return (
    <>
      ...
      />
      <main className="p-4 xl:px-2 pt-22 sm:pt-24 overflow-y-scroll lg:overflow-hidden lg:w-[80%] xl:w-[1100px] 2xl:w-[1350px] lg:mx-auto lg:pt-16 min-h-screen bg-amber-300 dark:bg-neutral-800">
        <BackButton />
