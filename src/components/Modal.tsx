...
function Modal() {
  ...
  return (
    <div
      className="fixed inset-0 z-50 bg-black/60 lg:-top-14 xl:-top-4"
      onClick={close}
    >
      <div
      ...
      >
        ...
        <h3
          className={`w-full sm:w-[90%] sm:text-center sm:mx-auto text-center ${content ? "text-lg" : "text-sm sm:text-[0.9rem] lg:text-[1rem]"} mt-1 sm:mt-4 lg:mt-0 xl:mt-4`}
        >
          {title}
        </h3>
        {content && <div className="mt-3 lg:mt-0">{content}</div>}
        <div className="flex justify-between items-center p-4 lg:p-2 sm:mt-4 lg:mt-0 xl:mt-4">
